...
export interface SafeShellConfig {
  ...
  /**
   * Route supported commands to native .ts implementations instead of
   * spawning the real binary; falls back to the real binary when the command
   * or its flags are unsupported.
   * Default: false.
   */
