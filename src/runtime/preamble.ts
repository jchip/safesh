...
export function buildPreamble(shell?: Shell, preambleConfig?: PreambleConfig): { preamble: string; preambleLineCount: number } {
  ...
  const preambleLines: string[] = [
    ...
    `import { cmd as __cmd, git as __git, docker as __docker, tmux as __tmux, str as __str, bytes as __bytes, toCmd as __toCmd, toCmdLines as __toCmdLines, initCmds as __initCmds } from 'file://${stdlibPath}command.ts';`,
    "",
    ...
    `  fs: __fs, text: __text,`,
    `  // Command execution`,
    `  cmd: __cmd, git: __git, docker: __docker, tmux: __tmux, str: __str, bytes: __bytes, toCmd: __toCmd, toCmdLines: __toCmdLines, initCmds: __initCmds,`,
