...
function statusRecordingLines(): string[] {
  return [
    ...
    "// SSH-674: $1/$@/$# lower to __POSITIONAL_PARAMS__ reads. A shell function",
    "// shadows this with its own rest parameter; at script level these are the",
    "// script's own arguments, and optional chaining cannot guard an UNDECLARED",
    "// identifier, so it has to exist for a top-level $1 to read as empty.",
    `const __POSITIONAL_PARAMS__: string[] = Deno.args ?? [];`,
    "",
...
export function buildPreamble(
  ...
  const preambleLines: string[] = [
    ...
    `import { default as __wc, wcMultiple as __wcMultiple } from 'file://${stdlibPath}../commands/wc.ts';`,
    ...
    `import { grepFiles as __grepFiles } from 'file://${stdlibPath}../commands/grep.ts';`,
    "",
    "// Import shelljs-like commands (aliased to avoid TDZ conflicts)",
    `import { echo as __echo, cd as __cd, pwd as __pwd, pushd as __pushd, popd as __popd, dirs as __dirs, tempdir as __tempdir, test as __test, which as __which, command as __commandBuiltin, chmod as __chmod, ln as __ln, rm as __rm, rmdir as __rmdir, cp as __cp, mv as __mv, mkdir as __mkdir, touch as __touch, ls as __ls, ShellString as __ShellString, getEnv as __getEnv, setEnv as __setEnv, deleteEnv as __deleteEnv, getAllEnv as __getAllEnv } from 'file://${stdlibPath}shelljs/mod.ts';`,
    "",
    ...
    "",
    "// Import shared shell value coercions",
    `import { printShellValue as __printShellValue, captureShellValue as __captureShellValue, commandSubstitutionText as __commandSubstitutionText } from 'file://${runtimePath}shell-value.ts';`,
    "",
  ];
  ...
  preambleLines.push(
    ...
    `  wc: __wc, wcMultiple: __wcMultiple, sort: __sort, uniq: __uniq, grepFiles: __grepFiles,`,
    `  // I/O streams`,
    ...
    `  globPaths: __fs.globPaths, globArray: __fs.globArray, __expandGlob: __fs.expandGlobArg, __expandGlobAll: __fs.expandGlobAll,`,
    `  // ShellJS commands`,
    `  echo: __echo, cd: __cd, pwd: __pwd, pushd: __pushd, popd: __popd, dirs: __dirs, tempdir: __tempdir, test: __test, which: __which, command: __commandBuiltin, chmod: __chmod, ln: __ln, rm: __rm, rmdir: __rmdir, cp: __cp, mv: __mv, mkdir: __mkdir, touch: __touch, ls: __ls, ShellString: __ShellString,`,
    `  // Environment helpers`,
