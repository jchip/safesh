...
import type { AwkArrayAccess, AwkExpr, AwkStmt, AwkVariable } from "../ast.ts";
import { formatPrintf } from "../builtins.ts";
import type { AwkRuntimeContext } from "./context.ts";
import { evalExpr, setBlockExecutor, ExecutionLimitError } from "./expressions.ts";
import { isTruthy, toAwkString, toNumber } from "./helpers.ts";
import { deleteArray, deleteArrayElement } from "./variables.ts";
